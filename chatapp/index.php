...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal">MyChatApp</h1>
    <p class="lead font-weight-normal">You can chat here without creating any logs. Now you are able to chat with your friends and family anytime anywhere.</p>

    <form method="post" action="create.php">
      MyChatApp.com <input type="text" name="room">
    

    <button class="btn btn-outline-secondary" href="#" type="submit">Create Room</button>
    </form> 
  </div>
